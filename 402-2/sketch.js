...
function draw()
{
	...
	else if (det.locationX < 700 && det.locationY < 320)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	else if (det.locationY > 320 && det.locationX > 390)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationX < 390 && det.locationY < 440)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	else if (det.locationY > 440 && det.locationX > 200)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationX < 200 && det.locationY < 630)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	else if (det.locationY > 630)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
